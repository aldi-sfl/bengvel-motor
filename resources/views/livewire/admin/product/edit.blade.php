        ...
        <div class="max-w-2xl px-4 py-8 mx-auto lg:py-16">
            ...
            <form wire:submit.prevent="updateProductInfo" enctype="multipart/form-data">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <button type="button" wire:click="BackTo" class="inline-flex items-center px-5 py-2.5 text-sm text-center font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                        Cancel
                    </button>
                </div>
            </form>
